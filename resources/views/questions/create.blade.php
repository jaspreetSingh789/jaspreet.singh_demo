<x-app-layout>
    <section class="flex-auto m-5">
        ...
        <main class="w-full mt-5 border border-gray-50 p-6 bg-white relative">
            <form method="post" action="{{ route('courses.tests.questions.store',[$course,$unit,$test]) }}" class="mt-5">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <button name="action" type="submit" class=" bg-gray-500 text-white rounded px-4 py-2 hover:bg-gray-400 ">Save & Add Another</button>
